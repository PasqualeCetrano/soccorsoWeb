...
public class SecurityHelpers {
    ...
    public static HttpSession checkSession(HttpServletRequest r, boolean loginAgeCheck) {
        ...
        //
        if (s.getAttribute("userid") == null || s.getAttribute("roles") == null || s.getAttribute("username") == null
                || start_ts == null) {
...
>>>>>>> 4bfd61d81a22955fffe269cb3397453437584b77
        //
